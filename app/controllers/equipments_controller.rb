class EquipmentsController < ApplicationController
  ...
  private
    ...
    def asset_params
      params.require(:asset).permit(:marca, :modelo, :serial, :url_factura, :status, :tecnologia_DD1, :tecnologia_DD2, :capacidad_DD1, :capacidad_DD2, :fecha_inicio_garantia, :fecha_fin_garantia, :observaciones, :asset_type_id)
    end
end