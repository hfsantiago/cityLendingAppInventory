...
class AssetTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create asset_type" do
    assert_difference("AssetType.count") do
      post asset_types_url, params: { asset_type: { nombre: @asset_type.nombre, observaciones: @asset_type.observaciones } }
    end
  ...
  test "should update asset_type" do
    patch asset_type_url(@asset_type), params: { asset_type: { nombre: @asset_type.nombre, observaciones: @asset_type.observaciones } }
